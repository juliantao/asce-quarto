...
[9](#app:options){reference-type="ref" reference="app:options"}. If you
...
list has been included in this template; see Appendix
[8](#app:notation){reference-type="ref" reference="app:notation"}.
...
This template includes an example of a figure (@fig-fill-between) and a table
(@tbl-assembly). 
The example figure has a caption with no more information than the figure itself, a very poor practice indeed. A reference here [@Stahl:2004a].
...
# LaTeX Template Options {#app:options}
